...
#define AI_CLD_MODEL_NAME          "cld"

#define AI_CLD_ACTIVATIONS_ALIGNMENT   (4)

#define AI_CLD_IN_NUM       (1)
#define AI_CLD_IN { \
  AI_BUFFER_OBJ_INIT(AI_BUFFER_FORMAT_U8, 112, 112, 3, 1, NULL), \
}
#define AI_CLD_IN_SIZE { \
  (112 * 112 * 3), \
}
#define AI_CLD_IN_1_SIZE  (112 * 112 * 3)
#define AI_CLD_IN_1_SIZE_BYTES  ((112 * 112 * 3) * 1)





#define AI_CLD_OUT_NUM      (1)
#define AI_CLD_OUT { \
  AI_BUFFER_OBJ_INIT(AI_BUFFER_FORMAT_U8, 1, 1, 4, 1, NULL), \
}
#define AI_CLD_OUT_SIZE { \
  (1 * 1 * 4), \
}
#define AI_CLD_OUT_1_SIZE  (1 * 1 * 4)
#define AI_CLD_OUT_1_SIZE_BYTES  ((1 * 1 * 4) * 1)

#define AI_CLD_N_NODES (18)
 ...
 * @ref ai_cld_create. Both the activations memory buffer 
 ...
 * header generated by the code generation tool. See AI_CLD_*
 * defines into file @ref cld.h for all network sizes defines
 *
 * @param network an opaque handle to the network context
